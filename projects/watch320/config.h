...
#ifndef __CONFIG_WATCH_DEV_V1_0_H__
#define __CONFIG_WATCH_DEV_V1_0_H__
...
#define DEFAULE_START_FUNC              FUNC_LATEST_N_DAY_NOT_ENOUGH_SPACE_PAGE       //默认开始任务
