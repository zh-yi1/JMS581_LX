...
static void func_clock_sub_card_compo_create(compo_form_t *frm)
{
    ...
    compo_cardbox_icon_set(cardbox, 0, UI_BUF_MUSIC_PREV_CLICK_BIN);
    ...
    compo_cardbox_icon_set(cardbox, 2, UI_BUF_MUSIC_NEXT_CLICK_BIN);
...
{
    printf("func_clock_sub_card_form_create\n");
