...
compo_form_t *func_menu_sub_kale_form_create(void)
{
	...
	// compo_kale_add_time(kale, COMPO_RINGS_TIME_TYPE_HOUR, UI_BUF_ICON_ACTIVITY_BIN, 1, 2, KALE_ICON_OUTER_SIZE);
    // UI精简: clock_h/m/s.bin 已删
    // compo_kale_add_time(kale, COMPO_RINGS_TIME_TYPE_MIN, UI_BUF_ICON_ACTIVITY_BIN, 1, 2, KALE_ICON_OUTER_SIZE);
    // UI精简: clock_h/m/s.bin 已删
    // compo_kale_add_time(kale, COMPO_RINGS_TIME_TYPE_SEC, UI_BUF_ICON_ACTIVITY_BIN, 9, 2, KALE_ICON_OUTER_SIZE);
