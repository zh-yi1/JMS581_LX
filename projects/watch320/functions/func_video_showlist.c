...
//        compo_form_destroy(frm);
        ...
        showlist_set_idx = listbox->focus_icon_idx;
    }
}
...
void func_video_showlist_enter(void)
{
    ...
    compo_listbox_move_init_modify(listbox, 127, compo_listbox_gety_byidx(listbox, TBL_3D_SHOWLIST_CNT - 2));
